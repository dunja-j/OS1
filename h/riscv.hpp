...
public:
    ...
    enum scauses {
        ...
        ILLEGAL_WRITE_ADDRESS = 0x0000000000000005UL,
        ILLEGAL_READ_ADDRESS = 0x0000000000000007UL,
        USER_ECALL = 0x0000000000000008UL,
        SYSTEM_ECALL = 0x0000000000000009UL
    };
